...
export const AuthBootstrapInput = AuthBrowserSessionRequest;
export type AuthBootstrapInput = AuthBrowserSessionRequest;
...
export const AuthBootstrapResult = AuthBrowserSessionResult;
export type AuthBootstrapResult = AuthBrowserSessionResult;
