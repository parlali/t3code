...
export interface LocalApi {
  ...
  server: {
    ...
    getMachineProcesses: () => Promise<ServerMachineProcessSnapshot>;
    getProcessResourceHistory: (
      input: ServerProcessResourceHistoryInput,
    ) => Promise<ServerProcessResourceHistoryResult>;
    signalProcess: (input: ServerSignalProcessInput) => Promise<ServerSignalProcessResult>;
    signalMachineProcess: (input: ServerSignalProcessInput) => Promise<ServerSignalProcessResult>;
  };
}
...
export interface EnvironmentApi {
  ...
  threadStatus: {
    getSnapshot: () => Promise<ThreadStatusSnapshot>;
    markRead: (input: ThreadStatusMarkReadInput) => Promise<ThreadStatusMutationEvent>;
    markUnread: (input: ThreadStatusMarkUnreadInput) => Promise<ThreadStatusMutationEvent>;
    markViewed: (input: ThreadStatusMarkViewedInput) => Promise<ThreadStatusMutationEvent>;
    setTerminalOpen: (
      input: ThreadStatusSetTerminalOpenInput,
  ...
  vcs: {
    ...
    stageFile: (input: VcsFileInput) => Promise<VcsStatusResult>;
    stageFiles: (input: VcsPathsInput) => Promise<VcsStatusResult>;
    unstageFile: (input: VcsFileInput) => Promise<VcsStatusResult>;
    unstageFiles: (input: VcsPathsInput) => Promise<VcsStatusResult>;
    revertFile: (input: VcsFileInput) => Promise<VcsStatusResult>;
    applyPatch: (input: VcsApplyPatchInput) => Promise<VcsStatusResult>;
