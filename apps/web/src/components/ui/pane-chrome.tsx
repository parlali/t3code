...
export const PANE_RESIZE_RAIL_CLASS =
  "group relative z-1 w-1 shrink-0 touch-none select-none cursor-col-resize bg-transparent outline-none before:absolute before:inset-y-0 before:left-1/2 before:w-px before:-translate-x-1/2 before:bg-border/70 before:transition-colors hover:before:bg-primary/45 focus-visible:before:bg-primary/45";
