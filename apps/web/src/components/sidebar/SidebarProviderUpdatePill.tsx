...
export function SidebarProviderUpdatePill() {
  ...
  return (
    <div
      className={`group/provider-update relative flex h-7 w-full transform-gpu items-center overflow-hidden rounded-lg text-xs font-medium transition-all duration-[180ms] ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform ${
