...
type FirstPartyBrowserSessionHandler = () => Effect.Effect<AuthBrowserSessionResult>;
...
interface EnvironmentHttpTestScenario {
  ...
  readonly firstPartyBrowserSession?: FirstPartyBrowserSessionHandler;
...
export interface EnvironmentHttpTestCalls {
  ...
  firstPartyBrowserSession: number;
        ...
        HttpApiBuilder.group(EnvironmentHttpApi, "auth", (handlers) =>
          handlers
            ...
            .handle(
              ...
              Effect.fn("test.environment.auth.firstPartyBrowserSession")(function* () {
                calls.firstPartyBrowserSession += 1;
                return yield* (
                  scenario.firstPartyBrowserSession?.() ??
                    unexpectedEndpoint("auth.firstPartyBrowserSession")
                );
              }),
            )
