  ...
  static readonly layerTest = (overrides: DeepPartial<ServerSettings> = {}) =>
    Layer.effect(
      ...
      Effect.gen(function* () {
        ...
        const merged = deepMerge(DEFAULT_SERVER_SETTINGS, overridesForMerge) as ServerSettings;
        const initialSettingsInput = {
          ...merged,
          ...(automaticGitFetchInterval !== undefined
            ? {
                automaticGitFetchInterval:
                  automaticGitFetchInterval as unknown as Duration.Duration,
              }
            : {}),
        } as unknown as ServerSettings;
        const initialSettings = yield* normalizeServerSettings(initialSettingsInput);
